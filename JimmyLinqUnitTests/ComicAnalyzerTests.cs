...
namespace JimmyLinqUnitTests
{
    ...
    public class ComicAnalyzerTests
    {
        ...
        [TestMethod]
        public void Comic_Analyzer_Should_Generate_A_List_Of_Reviews()
        {
            var TestReviews = new[]
            {
            ...
            var testReviews = new[]
            {
                new Review {Issue = 1, Critic = Critics.MuddyCritic, Score = 20 },
                new Review {Issue = 1, Critic = Critics.MuddyCritic, Score = 20 },
                new Review {Issue = 2, Critic = Critics.MuddyCritic, Score = -1 },
            };
